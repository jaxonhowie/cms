...
<div class="main-container ace-save-state" id="main-container">
    ...
    <div class="page-content">
        <div class="col-xs-12"><a href="/project/edit">
            ...
            <div>
                <div id="dynamic-table_wrapper" class="dataTables_wrapper form-inline no-footer">
                    <form method="get" action="/project/list" id="sform">
                        <div class="row">
                            <div class="col-xs-6">
                    ...
                    <table id="dynamic-table" class="table table-striped table-bordered table-hover dataTable no-footer"
                        ...
                        <tr role="row">
                            ...
                            <th class="hidden-10 sorting_disabled" tabindex="0" rowspan="1" colspan="1">ID</th>
                            <th class="sorting_disabled" tabindex="0" rowspan="1" colspan="1">项目名称</th>
                            <th class="sorting_disabled" tabindex="0" rowspan="1" colspan="1">简称</th>
                            <th class="hidden-480 sorting_disabled" tabindex="0" rowspan="1" colspan="1">项目描述</th>
                        ...
                        <#--<th class="hidden-480 sorting_disabled" tabindex="0" rowspan="1" colspan="1">更新时间</th>-->
                        ...
                        <tr role="row" class="odd">
                            <td class="center">
                                <label class="pos-rel">
                                    <input type="checkbox" name="checkbox" value="${projectinfo.oid}" class="ace">
                                    <span class="lbl"></span>
                                </label>
                            </td>
                            ...
                            <td>${projectinfo.abbrName!}</td>
                            <td>${projectinfo.projectDesc!}</td>
                        <#--<td class="hidden-480"><#if user.creator==0>系统初始化用户<#else>${user.createUser!}</#if></td>-->
                            <td><#if projectinfo.status=='00'><p class="green">正常<#else ><p class="red">异常</#if></p>
                            </td>
                        <#--<td>${projectinfo.oitime!}</td>-->
                            <td class="hidden-480">
                            ${projectinfo.oitime?string("yyyy-MM-dd HH:mm:ss")}
                            </td>
                        <#--<td>${projectinfo.outime!}</td>-->

                            <td>
                                <div class="hidden-sm hidden-xs action-buttons">
                                    <a class="green" href="/project/edit?oid=${projectinfo.oid}" attr="编辑项目信息">
                                        <i class="ace-icon fa fa-pencil bigger-130"></i>
                                    </a>
                                <#--${authorities?seq_contains("/admin/user/role")?string(' <a class="green" href="/admin/user/role/?id=${user.id}">-->
                                        <#--<i class="ace-icon fa fa-cog bigger-130"></i>-->
                                    <#--</a>','')}-->
                                <a class="red" onclick="del('${projectinfo.oid}')">
