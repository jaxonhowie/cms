                    ...
                    <#list children as child>
                        <#if child.children?? && child.children?size gt 0>
                            <li><a class="dropdown-toggle"
                                   href="javascript:addTabs({id:'${child.id},title: '${child.name}',close: true,url:'${child.url}'})">
                                <i class="menu-icon fa ${child.icon}"></i> <span class="menu-text">${child.name} </span><b
                        ...
                        <#else>
                            <li>
                                <a href="javascript:addTabs({id:'${child.id}',title: '${child.name}',close: true,url: '${child.url}'})">
                                    <i class="menu-icon fa ${child.icon!''}"></i> <span
                                        class="menu-text">${child.name} </span></a></li>
                        </#if>
                    </#list>
                </#if>
            </#macro>
