...
<head>
    ...
    <link rel="stylesheet"
          href="/cms/assets//font-awesome/4.5.0/css/font-awesome.min.css" />
        ...
        <div class="navbar-buttons navbar-header pull-right"
            ...
            <ul class="nav ace-nav">
                <li class="light-blue dropdown-modal"><a
                        ...
                        class="nav-user-photo" src="/cms/assets//images/avatars/user.jpg"
...
<script type="text/javascript">
    if ('ontouchstart' in document.documentElement)
        document
                .write("<script src='/cms/assets//js/jquery.mobile.custom.min.js'>"
                        + "<"+"/script>");
</script>
...
<!--[if lte IE 8]>
<script src="/cms/assets//js/excanvas.min.js"></script>
<![endif]-->
<script src="/cms/assets//js/jquery-ui.custom.min.js"></script>
<script src="/cms/assets//js/jquery.ui.touch-punch.min.js"></script>
<script src="/cms/assets//js/jquery.easypiechart.min.js"></script>
<script src="/cms/assets//js/jquery.sparkline.index.min.js"></script>
<script src="/cms/assets//js/jquery.flot.min.js"></script>
<script src="/cms/assets//js/jquery.flot.pie.min.js"></script>
<script src="/cms/assets//js/jquery.flot.resize.min.js"></script>

<!-- ace scripts -->
<script src="/cms/assets//js/ace-elements.min.js"></script>
<script src="/cms/assets//js/ace.min.js"></script>
<!--<script src="/cms/assets//js/sidebar-menu.js"></script>-->
<script src="/cms/assets//js/bootstrap-tab.js"></script>
